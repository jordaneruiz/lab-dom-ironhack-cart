...
function calculateAll() {
  ...
  products.forEach((singleProduct) => {
    ...
    //this also works: 
    //totalSum += updateSubtotal(singleProduct); // ** this line will execute the updateSubtotal for each product, meaning the subtotal will update on the DOM and also the function will return the subtotal amount
